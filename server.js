...
// ==========================================
// 📧 ตั้งค่าระบบส่งอีเมลด้วย Nodemailer (ซ่อนรหัสผ่านไว้บน Cloud)
// ==========================================
const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
        user: process.env.EMAIL_USER, // ดึงค่าอีเมลจากเว็บ Render
        pass: process.env.EMAIL_PASS  // ดึงค่ารหัสผ่าน 16 หลักจากเว็บ Render
    }
});
...
app.post('/send-booking-email', authenticateToken, async (req, res) => {
    try {
        ...
        const mailOptions = {
            from: process.env.EMAIL_USER || 'jirakitt1724@gmail.com', // ดึงจาก Cloud ปลอดภัย 100%
            to: recipientEmail,
