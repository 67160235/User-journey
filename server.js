...
// ==========================================
// 📧 ตั้งค่าระบบส่งอีเมลด้วย Nodemailer (ใส่ Gmail และ App Password ของจริง)
// ==========================================
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'jirakitt1724@gmail.com', // อีเมล Gmail ของคุณ
        pass: 'xttnxwzrovamlzre'        // รหัสผ่าน 16 หลัก (ลบช่องว่างออกแล้ว)
    }
});
...
app.post('/send-booking-email', authenticateToken, async (req, res) => {
    try {
        ...
        const mailOptions = {
            from: 'jirakitt1724@gmail.com', // ใช้อีเมลของคุณเป็นผู้ส่ง
            to: recipientEmail,
