...
// ==========================================
// 🔌 5. เชื่อมต่อ Database และ Start Server
// ==========================================
const PORT = process.env.PORT || 3000;
const MONGO_URI = process.env.MONGO_URI || 'mongodb://db:27017/hvacr_db'; 
// หมายเหตุ: ใช้ mongodb://db:27017 เพราะเราใช้ Docker Compose ลิงก์ชื่อ service "db" เข้าด้วยกัน
